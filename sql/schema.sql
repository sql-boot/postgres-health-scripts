...
*/
select schema_name  /* { "text": "Schema", "description": "Name of the schema" } */
     , schema_owner /* { "text": "Owner", "description": "Name of the owner of the schema" } */
     , case
         when tables_count>0 then json_build_object('label', tables_count, 'link', 'table/'||schema_name) 
       end as tables /* { "text": "Tables", "sortable": false, "description": "The number of tables in the scheme" } */
     , case
         when views_count>0 then json_build_object('label', views_count, 'link', 'view/'||schema_name)
       end as views /* { "text": "Views", "sortable": false, "description": "The number of view in the scheme" } */
  from (select *
             , (select count(1)
